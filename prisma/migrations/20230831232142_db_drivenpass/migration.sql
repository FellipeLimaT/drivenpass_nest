...
CREATE TABLE
    "credentials" (
        ...
        "title" TEXT NOT NULL,
        "url" TEXT NOT NULL,
        "credentialsUser" TEXT NOT NULL,
        "credentialsPass" TEXT NOT NULL,
        "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
        "updatedAt" TIMESTAMP(3) NOT NULL,
...
ALTER TABLE "cards"
ADD
    CONSTRAINT "cards_cardTypeId_fkey" FOREIGN KEY ("cardTypeId") REFERENCES "cardtypes"("id") ON DELETE
